...
//TEXTO
  ...
  textAlign(CENTER)
  textSize(24)
  text("*Regra Da Fase:          pode haver vetores dentro do retângulo\ne tem que usar todos os 3 vetores disponíveis",width/2,115)
  fill(220,100,100)
  text("NÃO",width/2-120,115)
  pop()
//BOTOES
  if(vitoria==false){
...
//CONTROLES
  ...
  if(mag(vetor[contador_vetores][0],vetor[contador_vetores][1])!=0){
      contador_vetores++
    }else if(contador_vetores==3 && mag(vetor[contador_vetores][0],vetor[contador_vetores][1])==0){
...
image(vitoriaproximafase,width/2,height/2,800,800*vitoriaproximafase.height/vitoriaproximafase.width)
  ...
  if(vitoria==false){
    ...
    if(contador_vetores==1 && mag(vetor[0][0],vetor[0][1])!=0 && vetor[0][0]+x>190 && vetor[0][0]+x<1085 && vetor[0][1]+y>285 && vetor[0][1]+y<435){
      derrota = true
      erro = true
    }
    if(contador_vetores==2 && mag(vetor[1][0],vetor[1][1])!=0 && vetor[1][0]+vetor[0][0]+x>190 && vetor[1][0]+vetor[0][0]+x<1085 && vetor[1][1]+vetor[0][1]+y>285 && vetor[1][1]+vetor[0][1]+y<435){
      derrota = true
      erro = true
    }
    if(contador_vetores==3 && mag(vetor[2][0],vetor[2][1])!=0 && vetor[2][0]+vetor[1][0]+vetor[0][0]+x>190 && vetor[2][0]+vetor[1][0]+vetor[0][0]+x<1085 && vetor[2][1]+vetor[1][1]+vetor[0][1]+y>285 && vetor[2][1]+vetor[1][1]+vetor[0][1]+y<435){
      derrota = true
      erro = true
    }
  }
