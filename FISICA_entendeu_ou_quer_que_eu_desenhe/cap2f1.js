...
//FAIXA DE CHEGADA
  ...
  rotate(60)
  translate(-940,-210)
image(faixa,950,210,245*altura/height,245*altura/height*faixa.height/faixa.width)
  pop()
//CARRO
  //Image
  push()
...
//OBJETOS
  ...
  //obj1
  triangle(112,550,112,65,1067,65)
  //obj2
  triangle(212,653,1168,653,1168,165)
  pop()
//BOTAO VOLTAR
...
//FÍSICA
  ...
  //obj1
  hit_frente_Obj1 = collideLineCircle(112,550,1067,65, x+versor_carro[0]*35,y+versor_carro[1]*35, 2*raioHitbox+0.001)
  if(hit_frente_Obj1){
    colisao(112,550,1067,65)
  }
  //obj2
  hit_frente_Obj2 = collideLineCircle(212,653,1168,165, x+versor_carro[0]*35,y+versor_carro[1]*35, 2*raioHitbox+0.001)
  if(hit_frente_Obj2){
    colisao(212,653,1168,165)
  }
//DERROTA E VITORIA
  //vitoria
  hit_frente_Faixa = collideLineCircle(900, 150, 967, 267,x+versor_carro[0]*35,y+versor_carro[1]*35, 2*raioHitbox+0.001)
  if(hit_frente_Faixa){
    vitoria=true
  }
...
image(vitoriaproximafase,width/2,height/2,800,800*vitoriaproximafase.height/vitoriaproximafase.width)
  ...
  if(hit_frente_ParedeC || hit_frente_ParedeB || hit_frente_ParedeE || hit_frente_ParedeD || hit_frente_Obj1 || hit_frente_Obj2){
    bateu=true
  }else{
    bateu=false
  }
